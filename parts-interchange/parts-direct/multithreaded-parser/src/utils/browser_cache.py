...
class BrowserCache:
    ...
    def __init__(self, cfg: Config, secondary_lookup_dir: str = None):
        """
        ...
        self.data_dir = os.path.join(self.base_dir, SaveFiles.WEBCACHE_DIR)
    ...
    def add_to_cache(self, page_url, page_text):
        """
        Cleans the provided page url and creates a uuid name from it which becomes the filename along with the bz2 extension.
        Saves page text within the data directory and adds url: filename record to hashmap
